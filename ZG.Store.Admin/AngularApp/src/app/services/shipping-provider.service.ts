...
export class ShippingProviderService {
    ...
    private shippingProviderUrl = this.apiBaseUrls.shippingProviderUrl;

    constructor(private authService: AuthService, private http: Http) { }

    getShippingProvisers(): Observable<ShippingProvider[]> {
        const headers = this.getHeaders(false);
        let url = `${this.shippingProviderUrl}`;
    ...
    extractData(response: Response){
        ...
        return body as ShippingProvider[] || [];
    }
