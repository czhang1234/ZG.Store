...
var routes = [
    ...
    { path: 'productcategories', component: product_categories_component_1.ProductCategoriesComponent },
    { path: 'prodcatdetails/:id', component: product_category_form_component_1.ProductCategoryFormComponent },
];
