...
namespace ZG.Store.Services.Migrations
{
    ...
    [Migration("20170612014219_CreateUOrderTables1")]
    partial class CreateUOrderTables1
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.Country", b =>
                {
                    b.Property<int>("CountryId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.OrderProduct", b =>
                {
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.OrderStatus", b =>
                {
                    b.Property<int>("OrderStatusId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.Province", b =>
                {
                    b.Property<int>("ProvinceId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.Shipping", b =>
                {
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.ShippingProvider", b =>
                {
                    b.Property<int>("ShippingProviderId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.State", b =>
                {
                    b.Property<int>("StateId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.Tax", b =>
                {
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.Address", b =>
                {
                    b.HasOne("ZG.Store.Services.Models.Country", "Country")
                        .WithMany("Addresses")
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ZG.Store.Services.Models.Province", "Province")
                        .WithMany("Addresses")
                        .HasForeignKey("ProvinceId");

                    b.HasOne("ZG.Store.Services.Models.State", "State")
                        .WithMany("Addresses")
                        .HasForeignKey("StateId");

                    b.HasOne("ZG.Store.Services.Models.User", "User")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.Order", b =>
                {
                    b.HasOne("ZG.Store.Services.Models.Country", "BillingCountry")
                        .WithMany("OrdersBilling")
                        .HasForeignKey("BillingCountryId");

                    b.HasOne("ZG.Store.Services.Models.Province", "BillingProvince")
                        .WithMany("OrdersBilling")
                        .HasForeignKey("BillingProvinceId");

                    b.HasOne("ZG.Store.Services.Models.State", "BillingState")
                        .WithMany("OrdersBilling")
                        .HasForeignKey("BillingStateId");

                    b.HasOne("ZG.Store.Services.Models.OrderStatus", "OrderStatu")
                        .WithMany("Orders")
                        .HasForeignKey("OrderStatusId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ZG.Store.Services.Models.Country", "ShippingCountry")
                        .WithMany("OrdersShipping")
                        .HasForeignKey("ShippingCountryId");

                    b.HasOne("ZG.Store.Services.Models.ShippingProvider", "ShippingProvider")
                        .WithMany("Orders")
                        .HasForeignKey("ShippingProviderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ZG.Store.Services.Models.Province", "ShippingProvince")
                        .WithMany("OrdersShipping")
                        .HasForeignKey("ShippingProvinceId");

                    b.HasOne("ZG.Store.Services.Models.State", "ShippingState")
                        .WithMany("OrdersShipping")
            ...
            modelBuilder.Entity("ZG.Store.Services.Models.OrderProduct", b =>
                {
                    b.HasOne("ZG.Store.Services.Models.Order", "Order")
